(function () {
     ...
     */
    function GettingStartedCtrl($meteor, $log, $state, Backand, BackandService, $interval) {

        console.log('GettingStartedCtrl');
        var start = this;
        start.filterData = $meteor.collection(FilterData);
        start.latestFilterData = FilterData.find({}, {'skip':0, 'limit':1,'sort':{'createdAt': -1}}).fetch();//,
        var listenInterval;
        var updateInterval;
    ...
    angular.module('socially')
        .controller('GettingStartedCtrl', ['$meteor', '$log', '$state', 'Backand', 'BackandService', '$interval', GettingStartedCtrl]);
})();
/**
